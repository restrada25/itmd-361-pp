...
2. Write the name of your group members here: Ruben Estrada, Daniel Vega

3. Copy and paste the URL for your group’s organization here: https://github.com/itmd-wolves

4. Copy and paste the URL for your shared repository here: https://github.com/itmd-wolves/project3
...
Write the URL for your personal fork of the repository here: https://github.com/restrada25/project3
...
group   git@github.com:itmd-wolves/project3.git (fetch)
group   git@github.com:itmd-wolves/project3.git (push)
origin  git@github.com:restrada25/project3.git (fetch)
origin  git@github.com:restrada25/project3.git (push)
...
Write the URL of your pull request here: https://github.com/itmd-wolves/project3/pull/1
